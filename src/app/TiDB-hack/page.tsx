export default function PlaceholderPage() {
  return (
    <div className="prose prose-lg p-6 max-w-3xl mx-auto">
      ...
      <p>
        Brief introduction or summary of the project. Explain what the project
        is, its purpose, and a one-liner impact.
      </p>
      ...
      <p>
        A paragraph or two describing your responsibilities, challenges you
